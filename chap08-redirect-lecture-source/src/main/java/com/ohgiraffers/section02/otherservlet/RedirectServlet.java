...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        /* 설명. 파라미터가 넘어오면 request 객체가 달라져도 전달된=ㅇ자 */
        System.out.println("리다이렉트 이휴 request의 parameter: " + req.getParameter("test"));

        /* 설명.
         *  redirect 시에는 request의 attribute 개념으로 다른 서블릿에세 값(상ㅌ)을 전달할 수 없다.
        ...
        * */
        ...
        /* 설명.
         *  포워딩 VS 리다이렉트
         *   - request 나 response 객체를 유지하여 요청 처리를 하고 싶다면 포워딩을 사용하자.
         *   - 클라이언트(브라우저)가 새로고침을 할 때마다 처음 요청하는 서블릿을 다시 호출하게 하고 싶지 않다면
         *     (INSERT 와 같은 경우) 리다이렉트를 사용하자.
         *
         * 설명.
