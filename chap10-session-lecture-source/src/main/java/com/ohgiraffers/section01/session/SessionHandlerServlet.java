...
public class SessionHandlerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        /* 설명
         *  요청이 서블릿으로 들어올 때 HttpServletRequest 에는 JSESSIONID라는 값이 Header 값에 포함되어 넘어온다.
         *  그럼 해당 JSESSIONID에 맟는 HttpSession 객체를 생성해서 해당 사용자를 위한 전용 저장 공간을 제공하게 된다.
         *  (요청을 보낸 사람 전용 Session 저장 공간을 생성하게 된다.
        * */
        HttpSession session = req.getSession();     // request 안에 있는 JsessionID
